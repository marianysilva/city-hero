...
export const SCREENS = [
  ...
  splash, citySelect, onbCamera, onbGame, onbPact, onbHood,
  // 02 · Núcleo do App
  homeMap, civicFeed, cameraLive, manualReport, reportConfirm,
  anonSend, heroesLeague, detailInProg, detailTicket, nps,
  myReports, detailMerged, syncQueue, notifications, cityProfile,
  programsHub, electedOfficials, bolsaFamilia, reportIrreg, servicesWorks, worksFeed, workDetail,
  // 03 · Gamificação
  citizenProf, achievements, ranking,
];
