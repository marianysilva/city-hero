...
const QUEUE = [
  {
    state: "waiting",
    badge: "AGUARDANDO",
    badgeC: "bg-amber-100 text-amber-700",
    cat: "🕳️ Buraco",
    addr: "R. Beira Mar, 1280",
    time: "Hoje · 14:32",
    size: "1 foto · 2.4MB",
  ...
  },
  {
    state: "syncing",
    badge: "ENVIANDO · 64%",
    badgeC: "bg-sky-100 text-sky-700",
    cat: "🗑️ Lixo acumulado",
    addr: "Pç. Central",
    time: "Hoje · 13:05",
    size: "2 fotos · 5.1MB",
    progress: 64,
  ...
  {
    state: "failed",
    badge: "FALHOU · Tentar de novo",
    badgeC: "bg-rose-100 text-rose-700",
    cat: "💡 Poste apagado",
    addr: "R. das Flores, 45",
    time: "Ontem · 21:14",
    size: "1 foto · 1.8MB",
