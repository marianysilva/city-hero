      ...
      markers: [
        {
          ...
          emoji: "🕳️",
          selected: true,
          title: "Buraco fundo · R. São Pedro 320",
        },
        {
          pos: [-27.157, -48.5548],
          bg: "#10B981",
          emoji: "🗑️",
          title: "Lixo acumulado · Av. Atlântica",
        },
        {
          pos: [-27.1578, -48.5532],
          bg: "#0EA5E9",
          emoji: "💡",
          sm: true,
          title: "Poste apagado · R. São Pedro",
        },
        {
          pos: [-27.1592, -48.5578],
          bg: "#7C3AED",
          emoji: "🚧",
          sm: true,
          title: "Calçada quebrada · R. Central",
        },
        {
          pos: [-27.1598, -48.5552],
          bg: "#F59E0B",
          emoji: "🕳️",
          sm: true,
          title: "Buraco pequeno · R. João Meller",
        },
        { pos: [-27.161, -48.5562], bg: "#F43F5E", emoji: "⚠️", title: "Risco · esquina R. XV" },
        {
          pos: [-27.1612, -48.554],
          bg: "#10B981",
          emoji: "🗑️",
