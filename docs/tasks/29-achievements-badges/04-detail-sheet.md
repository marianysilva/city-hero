...
Tapping a medal opens a large bottom sheet showing: large medal art, name, description, category, how to unlock (e.g., "Reportar problemas em 5 bairros diferentes"), progress toward unlock (if in-progress), unlock date (if conquistada), and a share button.
