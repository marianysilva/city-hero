...
A two-tile toggle: **Meu bairro** (default) vs **Cidade toda**. Switching changes the leaderboard's
scope. The default is "Meu bairro" so the user sees their nearest competitors first (motivating).
