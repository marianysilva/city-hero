...
The base layout: gradient hero slot at the top (task 02), scrollable content area for stats grid,
medals carousel, activity feed, settings (tasks 03–06), bottom nav with Profile tab active. A
"Editar perfil" floating button in the hero (handled by task 06).
