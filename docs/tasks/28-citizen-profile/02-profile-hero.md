...
A gradient hero (brand → civic-purple) with: user avatar, name + level title ("João, Guardião do
Bairro · Nível 15 ★"), city pill, XP value, and a progress bar to the next level showing N/M XP.
Decorative sparkles in the background. An "✏️ Editar perfil" link or floating button.
...
**Then** the title matches the level: 1-5 Cidadão, 6-15 Vigilante, 16-30 Guardião do Bairro, 31-50
Líder da Liga, 51+ Herói da Cidade
...
**Then** an edit modal opens (handled by task 06) with name, language, anonymous default,
