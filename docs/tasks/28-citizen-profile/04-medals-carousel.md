...
A horizontal carousel of the user's most recent medals (last 5-7). Each medal: emoji + name + small
"Desbloqueada em {date}" label. Tapping any opens SCREEN 29 (Achievements) scrolled to that medal. A
"Ver todas" link at the end takes the user to SCREEN 29 directly.
...
**Then** a soft empty message with the first medal preview ("Comece reportando · 🏅 Primeiro Reporte
te espera")
