...
> **Effort:** M (1-2 days)
> **Dependencies:** `25-services-public-works/01-render-services-ui-base.md`, `00-foundation/05-api-client.md`
> **Status:** ⬜ Not started
> **Labels:** `mobile`, `backend`, `screen`

## Context

A 2-column grid of large cards covering city services. Each card: emoji, label, subtitle, and a color-themed background. The catalog is per-city; for Pôrto Belo:
