...
A horizontal carousel of construction photos posted by the prefecture, organized by date (the user
can swipe through "Hoje, Ontem, Semana passada..."). Tapping opens a full-screen lightbox.
...
`public_work_photos` table with: id, work_id, photo_id (links to the photos table), posted_by_role,
posted_at, caption.
