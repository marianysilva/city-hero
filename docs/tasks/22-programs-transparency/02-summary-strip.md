...
A gradient (teal → indigo) summary card showing city-wide rolled-up metrics: "{city} · abr/2026",
"11 programas monitorados", plus three KPI cells: R$ investido/ano, beneficiários, níveis de
governo. This anchors the user in the scale of what they're about to see.
...
The hook fetches `/api/v1/cities/{id}/programs/summary` (count, total budget, beneficiaries,
levels).
...
- Cross-cutting: `docs/engineering/coding-standards.md`, `architecture-patterns.md`,
  `testing-strategy.md`
