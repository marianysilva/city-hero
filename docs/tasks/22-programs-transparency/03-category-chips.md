...
A horizontal scrollable row of category chips below the summary strip: **Todos** (default),
**Social**, **Saúde**, **Educação**, **Habitação**, **Estrutural**. Tapping a chip filters the
featured card (when matching) and the programs grid below.
