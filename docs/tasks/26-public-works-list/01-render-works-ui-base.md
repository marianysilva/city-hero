...
Header (back + "Obras em andamento · N" title + view toggle), small map preview at the top (task
02), sticky filter chips, scrollable list of works. Bottom nav visible.
