...
- Auth refresh: a dedicated endpoint accepts a refresh token, returns a new access/refresh pair, and
...
- **Integration**: end-to-end refresh on 401; retry on 5xx; non-retry on 4xx (except 401);
